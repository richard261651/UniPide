	...
	return (
		<DrawerPortal data-slot="drawer-portal">
			...
			<DrawerPrimitive.Content
				...
				className={cn(
					'group/drawer-content bg-white fixed z-50 flex h-auto flex-col shadow-2xl',
					...
					'data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-0 data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-[85vh] data-[vaul-drawer-direction=bottom]:rounded-t-3xl data-[vaul-drawer-direction=bottom]:border-t',
				...
				{...props}
			>
				<div className="bg-gray-300 mx-auto my-2.5 hidden h-1.5 w-12 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			...
			className={cn(
				'flex w-full flex-col gap-1 rounded-t-3xl border-b border-gray-100 px-5 py-4',
				className,
			)}
			{...props}
		/>
...
function DrawerBody({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			...
			className={cn('w-full px-5 py-4 flex-1 overflow-y-auto', className)}
			{...props}
		/>
	);
}
